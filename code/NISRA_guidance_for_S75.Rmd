...
#         div(class = "left"),
#         div(class = "middle", p("Guidance on the collection and reporting of section 75 categories", style = "margin: 0"),
#             p("Based primarily on GSS Harmonisation standards and guidance", style = "margin: 0, font-size: 0.5em"),
#             p("August 2024", style = "margin: 0, font-size: 0.5em")),
#         div(class = "right")),
#   
#       div(class = "row", style = "display: flex;  margin-left: 0px; margin-right: 0px",
...
```{r table 10}
  ...
  select("Racial Equality (TEO)" = Racial_Equality) %>%
kbl(escape = FALSE, vline = "|") %>%
  kable_styling(full_width = TRUE)
```
...
![](../Data/Racial_flow_chart.drawio.png)
...
kbl(escape = FALSE,  vline = "|", align = 'l') %>%
  kable_styling(full_width = TRUE)
```
